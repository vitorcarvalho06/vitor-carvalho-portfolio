...
export default function ChapterSection({
  ...
  return (
    ...
    >
      <FadeIn>
        <div className="mx-auto mb-16 max-w-[1200px] px-6 md:mb-20 md:px-10">
      ...
      <FadeIn delay={0.05}>
        <div className="mx-auto mb-8 w-full max-w-[1400px] px-6 md:mb-10 md:px-10">
          <button
            type="button"
            onClick={(event) =>
      ...
      <FadeIn delay={0.1}>
        <div className="mx-auto grid max-w-[1400px] grid-cols-12 gap-7 px-6 md:px-10">
          <div
            className={cn(
